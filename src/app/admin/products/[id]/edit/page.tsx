  ...
  return (
    <div style={{ maxWidth: '900px', margin: '0 auto' }}>
      <div className="admin-header">
        <div>
          <h1 className="admin-title">✏️ تعديل بيانا الفستان</h1>
          <p style={{ color: '#6B7280', fontSize: '14px', marginTop: '4px' }}>
            تحديث اسم الفستان، السعر، الوصف والألوان والمقاسات بسهولة
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            <textarea 
              ...
              placeholder="تفاصيل القماش، التفصيل، أو أي ملاحظات إضافية..."
              style={{
                width: '100%',
                padding: '14px 18px',
                borderRadius: '14px',
          ...
          <button 
            ...
            disabled={saving}
          >
            {saving ? '⏳ جاري الحفظ...' : '💾 حفظ التعديلات الآن'}
          </button>
        </form>
      </div>
    </div>
